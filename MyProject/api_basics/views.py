...
#View Sets
class ArticleViewSet(viewsets.ViewSet):   #this kind we have to write all functionity by ourselves
    ...
    def retrieve(self, request, pk=None): #None is default in case pk is not passed
